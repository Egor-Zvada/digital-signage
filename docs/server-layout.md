...
Для работы без тяжёлой параллельной обработки достаточно 4 vCPU и 4 ГБ RAM, но
для стабильной подготовки 4K и Chromium рекомендуются 8 vCPU и 8–12 ГБ RAM.
Медиадиск рекомендуется увеличить минимум до 250 ГБ. Одновременно выполняется не
более одного тяжёлого FFmpeg-задания.
